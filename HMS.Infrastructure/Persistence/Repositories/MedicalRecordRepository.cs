...
public class MedicalRecordRepository(AppDbContext context)
    : Repository<MedicalRecord>(context),
        IMedicalRecordRepository
{
    public async Task<(IEnumerable<MedicalRecord> Items, int TotalCount)> GetPagedByPatientAsync(
        Guid patientId,
    ...
    {
        var q = Context
            .MedicalRecords.Include(mr => mr.Doctor)
